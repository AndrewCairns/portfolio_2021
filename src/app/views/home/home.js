  ...
  return (
    <section className="section-home">
      <div className="c-contain">
        <Grid fluid>
          <Row middle="xs" className="intro-column-reverse">
              ...
              <Row top="xs">
                ...
                <Col xs={12} sm={12} md={8} lg={8}>
                  ...
                  <p className="txt--brand-secondary txt--color-body txt--8">
                    I am an enthusiastic, adaptable and driven Front-end
                    engineer with experience in both academia and industry. I
                    have a PhD in medical informatics. I thrive in both the
                    competitive, fast-paced environment of start-up businesses,
                    and enterprise level application development, striving to
                    deliver product(s) of optimum quality.
                  </p>
                </Col>
              </Row>
            </Col>
